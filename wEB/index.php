...
<html>
    ...
    <script>
        function change(){
            x=document.getElementById("nlcsn");
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>MÃ LỚP</th>
                            <th colspan="2">
                                TÙY CHỌN <button type="submit"><a href="editsv.php" style="text-decoration: none">Thêm</a></button>
                            </th>
                        </tr>
                    </thead>
                    <tbody> 
                        <?php
                            include "getDB_SV.php";
                            for($i=0;$i<count($arr);$i++){
                                $temp="";
                                $temp.="<tr>";
                                $temp.= "<td>".$arr[$i]["mssv"]."</td>".
                                        "<td>".$arr[$i]["ten"]."</td>".
                                        "<td>".$arr[$i]["ns"]."</td>".
                                        "<td>".$arr[$i]["ml"]."</td>".
                                        "<td></td>
                                        <td><button><a href='xoadbc.php?table=sinhvien&field=MASV&value=".$arr[$i]["mssv"]."'>Xóa</a></button></td>";
                                $temp.="</tr>";
                                echo($temp);
                            }
                        ?>
