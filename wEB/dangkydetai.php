        ...
        <div id="main">
            <div id="left">
                <div class="menu_left">
                    ...
                    <ul>
                        ...
                        <li><a href="">Phân Công Công Tác</a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="#"><i class="fa fa-location-arrow"></i> Đăng Ký Đề Tài</a></li>
            ...
            <div id="right">
                ...
                <form action="xulydk.php" method="POST">
                    <label for="">Mã số sinh viên:</label><br>
                    <input name="mssv" type="text" value=""><br>

                    <label for="">Họ và tên:</label><br>
                    <input name="hovaten" type="text" value=""><br>

                    <label for="">Số điện thoại:</label><br>
                    <input name="phone" type="text" value=""><br>
                    
                    <label for="">Tên lớp (DI*):</label><br>
                    <input name="lop" type="text" value="" placeholder="DI*"><br>
                    
                    <label for="">Lựa chọn 1:</label><br>
                    <input name="uutien1" type="text" value="" placeholder="Ví dụ: 10"><br>

                    <label for="">Lựa chọn 2:</label><br>
                    <input name="uutien2" type="text" value="" placeholder="Ví dụ: 10"><br>

                    <label for="">Lựa chọn 3:</label><br>
                    <input name="uutien3" type="text" value="" placeholder="Ví dụ: 10"><br>

                    <label for="">Lựa chọn 4:</label><br>
                    <input name="uutien4" type="text" value="" placeholder="Ví dụ: 10"><br><br>

                    <center><button type="submit" name="submit">Đăng Ký</button></center><br>
                </form>
            </div>
        </div>
        <div id="footer">
