...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="right">
                <form action="xulygv.php" method="POST">
                    ...
                    <label for="">Bộ môn:</label><br>
                    <input name="bm" type="text" value=""><br>
                    
                    <label for="">Học vị:</label><br>
                    <input name="cv" type="text" value=""><br><br>
