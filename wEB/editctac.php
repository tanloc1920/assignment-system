...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="right">
                <form action="xulyctac.php" method="POST">
                    <label for="">Mã số giảng viên:</label><br>
                    <input name="msgv" type="text" value=""><br>

                    <label for="">Họ và tên GV:</label><br>
                    <input name="tengv" type="text" value=""><br>
                    
                    <label for="">Sự kiện công tác:</label><br>
                    <input name="sk" type="text" value=""><br>

                    <label for="">Địa điểm công tác:</label><br>
