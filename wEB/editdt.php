...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="right">
                <form action="xulydt.php" method="POST">
                    <label for="">Mã số giảng viên:</label><br>
                    <input name="msgv" type="text" value=""><br>

                    <label for="">Họ và tên:</label><br>
                    <input name="hovatengv" type="text" value=""><br>

                    <label for="">Mã số đề tài:</label><br>
                    <input name="mdt" type="text" value=""><br>
                    
                    <label for="">Tên đề tài:</label><br>
                    <input name="ten" type="text" value=""><br><br>
