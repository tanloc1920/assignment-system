        ...
        <div id="main">
            ...
            <div id="right">
                <form action="xulygd.php" method="POST">
                    ...
                    <input name="msgv" type="text" value=""><br>

                    <label for="">Tên môn:</label><br>
                    <input name="tenmon" type="text" value=""><br>
                    
                    <label for="">Mã môn:</label><br>
                    <input name="mm" type="text" value=""><br>

                    <label for="">Học kỳ:</label><br>
                    <input name="hk" type="text" value=""><br>

                    <label for="">Năm học:</label><br>
                    <input name="nh" type="text" value=""><br><br>
