                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>NĂM HỌC</th>
                            <th colspan="2">
                                TÙY CHỌN <button type="submit"><a href="editgd.php" style="text-decoration: none">Thêm</a></button>
                            </th>
                        </tr>
                    </thead>
                    <tbody> 
                        <?php
                            ...
                            for($i=0;$i<count($arr);$i++){
                                ...
                                $temp.=
                                        ...
                                        "<td>".$arr[$i]["nh"]."</td>".
                                        "<td></td>
                                        <td><button><a href='xoadb.php?table=giangday&field=id&value=".$arr[$i]["id"]."'>Xóa</a></button></td>";
                                $temp.="</tr>";
                                echo($temp);
                            }
                        ?>
