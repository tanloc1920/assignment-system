                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>TÍN CHỈ</th>
                            <th colspan="2">
                                TÙY CHỌN <button type="submit"><a href="editmh.php" style="text-decoration: none">Thêm</a></button>
                            </th>
                        </tr>
                    </thead>
                    <tbody> 
                        <?php
                            include "getDB_MH.php";
                            for($i=0;$i<count($arr);$i++){
                                ...
                                $temp.= "<td>".$arr[$i]["mm"]."</td>".
                                        ...
                                        "<td>".$arr[$i]["tc"]."</td>".
                                        "<td></td>
                                        <td><button><a href='xoadbc.php?table=monhoc&field=MM&value=".$arr[$i]["mm"]."&url=monhoc.php'>Xóa</a></button></td>";
                                $temp.="</tr>";
                                echo($temp);
                            }
                        ?>
