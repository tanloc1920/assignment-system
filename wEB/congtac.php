                ...
                <table>
                    <thead>
                        <tr>
                            <th>MAGV</th>
                            <th>HỌ VÀ TÊN GV</th>
                            <th>SỰ KIỆN CÔNG TÁC</th>
                            <th>NƠI CÔNG TÁC</th>
                            <th colspan="2">
                                TÙY CHỌN <button type="submit"><a href="editctac.php" style="text-decoration: none">Thêm</a></button>
                            </th>
                        </tr>
                    </thead>
                    <tbody> 
                        <?php
                            include "getDB_CTAC.php";
                            for($i=0;$i<count($arr);$i++){
                                $temp="";
                                $temp.="<tr>";
                                $temp.= "<td>".$arr[$i]["msgv"]."</td>".
                                        "<td>".$arr[$i]["hotengv"]."</td>".
                                        "<td>".$arr[$i]["sk"]."</td>".
                                        "<td>".$arr[$i]["dd"]."</td>".
                                        "<td></td>
                                        <td><button><a href='xoadb.php?table=congtac&field=id&value=".$arr[$i]["id"]."'>Xóa</a></button></td>";
                                $temp.="</tr>";
                                echo($temp);
                            }
                        ?>
