...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="right">
                <form action="xulygd.php" method="POST">
                    <label for="">Mã số giảng viên:</label><br>
                    <input name="msgv" type="text" value="<?php echo $row['MAGV']; ?>"><br>

                    <label for="">Tên môn:</label><br>
                    <input name="tenmon" type="text" value="<?php echo $row['TENMON']; ?>"><br>
                    
                    <label for="">Mã môn:</label><br>
                    <input name="mm" type="text" value="<?php echo $row['MM']; ?>"><br>

                    <label for="">Học kỳ:</label><br>
                    <input name="hk" type="text" value="<?php echo $row['HK']; ?>"><br>

                    <label for="">Năm học:</label><br>
                    <input name="nh" type="text" value="<?php echo $row['NH']; ?>"><br><br>
                
                    <button type="submit" value="Update" name="update">Thêm</button>
                </form>
            </div>
        </div>
        <div id="footer">
