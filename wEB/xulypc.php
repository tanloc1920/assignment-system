    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="right">
                    ...
                    <tbody> 
                        <?php
                            ...
                            for($i=0;$i<count($data);$i++){
                                $temp="";
                                $temp.="<tr>";
                                $temp.= "<td>".$data[$i]["ten"]."</td>".
                                        "<td>".$data[$i]["uutien1"]."</td>".
                                        "<td>".$data[$i]["uutien2"]."</td>".
                                        "<td>".$data[$i]["uutien3"]."</td>".
                                        "<td>".$data[$i]["uutien4"]."</td>".
                                        "<td></td>
                                        <td></td>";
                                $temp.="</tr>";
                                echo($temp);
                ...
                <br>
                <center><button onclick="show()">Kết quả</button></center>
                <table id="kq" style="display: none;">
                    <thead>
                        <tr>
                            <th>Sinh viên</th>
                            <th>Đề tài</th>
